...
oc policy add-role-to-user edit system:serviceaccount:integrated-cicd:jenkins -n test-site-slides-fiercesw-network
oc policy add-role-to-user edit system:serviceaccount:integrated-cicd:jenkins -n stage-site-slides-fiercesw-network
oc policy add-role-to-user edit system:serviceaccount:integrated-cicd:jenkins -n site-slides-fiercesw-network
